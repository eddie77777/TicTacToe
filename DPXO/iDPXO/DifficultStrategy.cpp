...
Position DifficultStrategy::WinOrBlock(char symbol, Board board)
{
...
Position DifficultStrategy::Corner(Board board)
{
...
Position DifficultStrategy::DifficultMove(Board board)
{
...
Position DifficultStrategy::MiddleEdge(Board board)
{
